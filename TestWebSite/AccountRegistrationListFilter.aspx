...
$(".RequestId,.UserName,.Password,.FirstName,.LastName,.Department,.Phone,.Fax,.Status,.CreateDate,.DeleteDate,.CancelDate,.ApprovedDate,.LastUpdate").autocomplete({ 
...
$('#modal1').openModal();
var result = AccountRegistrationService.Search(PageIndex, PageSize, SortExpression, SortDirection, RequestId,UserName,Password,FirstName,LastName,Department,Phone,Fax,Status,CreateDate,DeleteDate,CancelDate,ApprovedDate,LastUpdate,RederTable_Pagger);
...
TrTempplate +="</div>";
TrTempplate +="</td>";
TrTempplate +="<td class='tdDeleteDate'>";
TrTempplate +="<span>"+dateFormat(JsonDateToDate(result[key].DeleteDate), 'd mmm yyyy')+"</span>";
TrTempplate +="<div style='display: none'>";
TrTempplate +="<input data-column-id='DeleteDate'class='datepicker' type='date' value='"+dateFormat(JsonDateToDate(result[key].DeleteDate),'d mmm yyyy')+"' style='height: unset; margin: 0px;'>";
TrTempplate +="<label class='lblSave'>Save</label>";
TrTempplate +="<label class='lblCancel'>";
TrTempplate +="Cancel</label>";
TrTempplate +="</div>";
TrTempplate +="</td>";
TrTempplate +="<td class='tdCancelDate'>";
TrTempplate +="<span>"+dateFormat(JsonDateToDate(result[key].CancelDate), 'd mmm yyyy')+"</span>";
TrTempplate +="<div style='display: none'>";
TrTempplate +="<input data-column-id='CancelDate'class='datepicker' type='date' value='"+dateFormat(JsonDateToDate(result[key].CancelDate),'d mmm yyyy')+"' style='height: unset; margin: 0px;'>";
TrTempplate +="<label class='lblSave'>Save</label>";
TrTempplate +="<label class='lblCancel'>";
TrTempplate +="Cancel</label>";
TrTempplate +="</div>";
TrTempplate +="</td>";
TrTempplate +="<td class='tdApprovedDate'>";
TrTempplate +="<span>"+dateFormat(JsonDateToDate(result[key].ApprovedDate), 'd mmm yyyy')+"</span>";
TrTempplate +="<div style='display: none'>";
TrTempplate +="<input data-column-id='ApprovedDate'class='datepicker' type='date' value='"+dateFormat(JsonDateToDate(result[key].ApprovedDate),'d mmm yyyy')+"' style='height: unset; margin: 0px;'>";
TrTempplate +="<label class='lblSave'>Save</label>";
TrTempplate +="<label class='lblCancel'>";
TrTempplate +="Cancel</label>";
TrTempplate +="</div>";
TrTempplate +="</td>";
TrTempplate +="<td class='tdLastUpdate'>";
TrTempplate +="<span>"+dateFormat(JsonDateToDate(result[key].LastUpdate), 'd mmm yyyy')+"</span>";
TrTempplate +="<div style='display: none'>";
TrTempplate +="<input data-column-id='LastUpdate'class='datepicker' type='date' value='"+dateFormat(JsonDateToDate(result[key].LastUpdate),'d mmm yyyy')+"' style='height: unset; margin: 0px;'>";
TrTempplate +="<label class='lblSave'>Save</label>";
TrTempplate +="<label class='lblCancel'>";
TrTempplate +="Cancel</label>";
TrTempplate +="</div>";
...
$('.tdUserName,.tdPassword,.tdFirstName,.tdLastName,.tdDepartment,.tdPhone,.tdFax,.tdStatus,.tdCreateDate,.tdDeleteDate,.tdCancelDate,.tdApprovedDate,.tdLastUpdate').dblclick(function () { 
...
<th   data-column-id="DeleteDate"  onclick="Sort(this);">DeleteDate</th>
<th   data-column-id="CancelDate"  onclick="Sort(this);">CancelDate</th>
<th   data-column-id="ApprovedDate"  onclick="Sort(this);">ApprovedDate</th>
<th   data-column-id="LastUpdate"  onclick="Sort(this);">LastUpdate</th>
</tr>
</thead>
<tbody>
</tbody>
