...
TrTempplate +="<span>"+result[key].Photo+"</span>";
TrTempplate +="<div style='display: none'>";
TrTempplate +="<label class='lblSave'>Save</label>";
TrTempplate +="<label class='lblCancel'>";
TrTempplate +="Cancel</label>";
...
<input  id="txtEmployeeID" type="text" data-column-id="EmployeeID"  CssClass="validate EmployeeID" length="9" />
<label for="txtEmployeeID">EmployeeID </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtLastName" type="text" data-column-id="LastName"  class="validate LastName"   length="20"  /> 
<label for="txtLastName">LastName </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtFirstName" type="text" data-column-id="FirstName"  class="validate FirstName"   length="10"  /> 
<label for="txtFirstName">FirstName </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtTitle" type="text" data-column-id="Title"  class="validate Title"   length="30"  /> 
<label for="txtTitle">Title </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtTitleOfCourtesy" type="text" data-column-id="TitleOfCourtesy"  class="validate TitleOfCourtesy"   length="25"  /> 
<label for="txtTitleOfCourtesy">TitleOfCourtesy </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtBirthDate"  CssClass="datepicker" type ="date" runat="server"></asp:TextBox>
<label for="txtBirthDate">BirthDate </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtHireDate"  CssClass="datepicker" type ="date" runat="server"></asp:TextBox>
<label for="txtHireDate">HireDate </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtAddress" type="text" data-column-id="Address"  class="validate Address"   length="60"  /> 
<label for="txtAddress">Address </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtCity" type="text" data-column-id="City"  class="validate City"   length="15"  /> 
<label for="txtCity">City </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtRegion" type="text" data-column-id="Region"  class="validate Region"   length="15"  /> 
<label for="txtRegion">Region </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtPostalCode" type="text" data-column-id="PostalCode"  class="validate PostalCode"   length="10"  /> 
<label for="txtPostalCode">PostalCode </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtCountry" type="text" data-column-id="Country"  class="validate Country"   length="15"  /> 
<label for="txtCountry">Country </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtHomePhone" type="text" data-column-id="HomePhone"  class="validate HomePhone"   length="24"  /> 
<label for="txtHomePhone">HomePhone </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtExtension" type="text" data-column-id="Extension"  class="validate Extension"   length="4"  /> 
<label for="txtExtension">Extension </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtReportsTo" type="text" data-column-id="ReportsTo"  CssClass="validate ReportsTo" length="9" />
<label for="txtReportsTo">ReportsTo </label> 
 </div> 
<div class="input-field col s6"> 
<input  id="txtPhotoPath" type="text" data-column-id="PhotoPath"  class="validate PhotoPath"   length="255"  /> 
...
<table id=tbResult class="  bordered  striped "  style="display: none;" > 
  <thead> 
  <tr> 
<th style="width:300px;" data-column-id="EmployeeID"  onclick="Sort(this);">EmployeeID</th>
<th style="width:300px;" data-column-id="LastName"  onclick="Sort(this);">LastName</th>
<th style="width:300px;" data-column-id="FirstName"  onclick="Sort(this);">FirstName</th>
<th style="width:300px;" data-column-id="Title"  onclick="Sort(this);">Title</th>
<th style="width:300px;" data-column-id="TitleOfCourtesy"  onclick="Sort(this);">TitleOfCourtesy</th>
<th style="width:300px;" data-column-id="BirthDate"  onclick="Sort(this);">BirthDate</th>
<th style="width:300px;" data-column-id="HireDate"  onclick="Sort(this);">HireDate</th>
<th style="width:300px;" data-column-id="Address"  onclick="Sort(this);">Address</th>
<th style="width:300px;" data-column-id="City"  onclick="Sort(this);">City</th>
<th style="width:300px;" data-column-id="Region"  onclick="Sort(this);">Region</th>
<th style="width:300px;" data-column-id="PostalCode"  onclick="Sort(this);">PostalCode</th>
<th style="width:300px;" data-column-id="Country"  onclick="Sort(this);">Country</th>
<th style="width:300px;" data-column-id="HomePhone"  onclick="Sort(this);">HomePhone</th>
<th style="width:300px;" data-column-id="Extension"  onclick="Sort(this);">Extension</th>
<th style="width:300px;" data-column-id="Photo"  >Photo</th>
<th style="width:300px;" data-column-id="ReportsTo"  onclick="Sort(this);">ReportsTo</th>
<th style="width:300px;" data-column-id="PhotoPath"  onclick="Sort(this);">PhotoPath</th>
</tr>
</thead>
<tbody>
</tbody>
